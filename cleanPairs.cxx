...
void cleanPairs(){
    ...
    Int_t tag_DoubleIsoMu17Mu8_Mu17leg, DoubleIsoMu17Mu8_Mu8leg, DoubleIsoMu17Mu8_Mu17leg, tag_DoubleIsoMu17Mu8_Mu8leg, tag_DoubleIsoMu17Mu8dZ_Mu17leg,   DoubleIsoMu17Mu8dZ_Mu17leg, Mu17_IsoTrkVVL, tag_Mu17_IsoTrkVVL, Mu17, tag_Mu17, tag_IsoMu20, IsoMu20, tag_IsoTkMu20, IsoTkMu20 ;
    ...
    Int_t DoubleIsoMu17Mu8_IsoMu8leg, tag_DoubleIsoMu17Mu8_IsoMu8leg, DoubleIsoMu17Mu8_IsoMu17leg, tag_DoubleIsoMu17Mu8_IsoMu17leg;
    Int_t tag_DoubleIsoMu17TkMu8_IsoMu17leg, DoubleIsoMu17TkMu8_IsoMu17leg, tag_DoubleIsoMu17TkMu8_IsoMu8leg, DoubleIsoMu17TkMu8_IsoMu8leg;
   ...
   TFile *fOut = new TFile("/tmp/hbrun/tnpZ_theTreeCleaned_MC_eff_new.root", "RECREATE");
...
*/
      ...
      hr2DMCTrue -> Fill(abseta, tag_eta);
       ...
       //  if(tag_eta < 1.2 && tag_eta < 1.2 &&  abseta < 1.2 && abseta < 1.2) hr2DMCTrue -> Fill(abseta, tag_eta);
        ...
        Dz = 0;
        if((tag_DoubleIsoMu17TkMu8_IsoMu17leg&&DoubleIsoMu17Mu8_Mu8leg)||(DoubleIsoMu17Mu8_Mu17leg&&tag_DoubleIsoMu17Mu8_Mu8leg))
            DenomDz = 1;
        Dz = 1;
//----------------------with dz -----------------------------
        EffMu17Mu8 = 0;
