...
#IDS = ["DoubleIsoMu17Mu8_IsoMu17leg", "DoubleIsoMu17Mu8_IsoMu8leg", "DoubleIsoMu17TkMu8_IsoMu17leg", "DoubleIsoMu17TkMu8_IsoTkMu8leg"]

        DoubleIsoMu17Mu8_IsoMu8leg = cms.vstring("DoubleIsoMu17Mu8_IsoMu8leg", "dummy[pass=1,fail=0]"), # new
        tag_DoubleIsoMu17Mu8_IsoMu8leg = cms.vstring("tag_DoubleIsoMu17Mu8_IsoMu8leg", "dummy[pass=1,fail=0]"), # new

        DoubleIsoMu17TkMu8_IsoMu17leg = cms.vstring("DoubleIsoMu17TkMu8_IsoMu17leg", "dummy[pass=1,fail=0]"), # new
        tag_DoubleIsoMu17TkMu8_IsoMu17leg = cms.vstring("tag_DoubleIsoMu17TkMu8_IsoMu17leg", "dummy[pass=1,fail=0]"), # new

        DoubleIsoMu17TkMu8_IsoTkMu8leg = cms.vstring("DoubleIsoMu17TkMu8_IsoTkMu8leg", "dummy[pass=1,fail=0]"), # new
        tag_DoubleIsoMu17TkMu8_IsoTkMu8leg = cms.vstring("tag_DoubleIsoMu17TkMu8_IsoTkMu8leg", "dummy[pass=1,fail=0]"), # new
...
PT_ETA_BINS = cms.PSet(
                     ...
                     #   pt =  cms.vdouble(20,9999),
                        #tag_pt =  cms.vdouble(8, 12, 17, 20, 22, 30, 50, 80),
                        pt =  cms.vdouble(8, 12, 17, 20, 22, 30, 50, 80 , 120, 200, 500),
                     #  Expression = cms.vstring("pass")
                     #  DenomDz = cms.vstring("pass")
                     #  DenomMu17Eff = cms.vstring("pass")
			#Mu17 = cms.vstring("pass"),
			#tag_Mu17 = cms.vstring("pass")
...
#'file:/afs/cern.ch/user/a/agrebeny/eos/cms/store/group/phys_muon/hbrun/dataCommissioning/TnPtrees/DoubleMuSkim/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/TnPtreesMCdoubleMuon25ns/150930_133759/0000/tnpZ_MC_8.root'
    ...
    OutputFileName = cms.string("TnP_MuonID_pTeta_Mu17M8_%s.root" % scenario),
...
if "data" in scenario:
    process.TnP_MuonID.InputFileNames = cms.vstring(
						    ...
						    "file:/tmp/quwang/TnPTree_80X_Run2016B_v2_GoldenJSON_Run273731_to_274240_IncludingMissingLumi_Completed.root",
						    "file:/tmp/quwang/TnPTree_80X_Run2016B_v2_GoldenJSON_Run271036to273730_NotCompleted.root"
						    #"file:/tmp/quwang/tnpZ_theTreeCleaned_data_eff_Mu17Mu8Clean.root"
                                                    )
...
#IDS = ["DoubleIsoMu17TkMu8_IsoTkMu8leg"]
#IDS = ["DoubleIsoMu17Mu8_IsoMu17leg||tag_DoubleIsoMu17Mu8_IsoMu17leg", "DoubleIsoMu17Mu8_IsoMu8leg||tag_DoubleIsoMu17Mu8_IsoMu8leg", "DoubleIsoMu17TkMu8_IsoMu17leg||tag_DoubleIsoMu17TkMu8_IsoMu17leg", "DoubleIsoMu17TkMu8_IsoTkMu8leg||tag_DoubleIsoMu17TkMu8_IsoTkMu8leg"]
#IDS = ["EffMu17Mu8nodz"]
#IDS = ["EffMu17Mu8"]
#IDS = ["pathOr"]
#IDS = ["pathOrnodz"]
...
for ID in IDS:
    ...
    for X,B in ALLBINS:
        ...
        module = process.TnP_MuonID.clone(OutputFileName = cms.string("TnP_MuonID17_%s_%s_%s.root" % (scenario, ID, X)))
        shape = "vpvPlusExpo"
