...
void cleanPairs(){
   ...
   //TFile *fOut = new TFile("/tmp/quwang/tnpZ_theTreeCleaned_MC_eff_new.root", "RECREATE");
    TFile *fOut = new TFile("/afs/cern.ch/user/q/quwang/eos/cms/store/user/quwang/Trigger/tnpZ_theTreeCleaned_MC_eff_new.root", "RECREATE");
...
//----------------------no dz -----------------------------
       ...
       //Qun //if((tag_DoubleIsoMu17Mu8_Mu17leg&&DoubleIsoMu17Mu8_Mu8leg)||(DoubleIsoMu17Mu8_Mu17leg&&tag_DoubleIsoMu17Mu8_Mu8leg))
        EffMu17Mu8nodz = 1;
